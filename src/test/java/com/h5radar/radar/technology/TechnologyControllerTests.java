...
public class TechnologyControllerTests extends AbstractControllerTests {
  ...
  public void shouldGetTechnologies() throws Exception {
    ...
    mockMvc.perform(get("/api/v1/technologies")
        ...
        .andExpect(jsonPath("$.content[0].radar_user.id", equalTo(technologyDto.getRadarUserDto().getId()), Long.class))
        .andExpect(jsonPath("$.content[0].radar_user.sub", equalTo(technologyDto.getRadarUserDto().getSub())))
  ...
  public void shouldGetTechnology() throws Exception {
    ...
    mockMvc.perform(get("/api/v1/technologies/{id}", technologyDto.getId())
        ...
        .andExpect(jsonPath("$.radar_user.id", equalTo(technologyDto.getRadarUserDto().getId()), Long.class))
        .andExpect(jsonPath("$.radar_user.sub", equalTo(technologyDto.getRadarUserDto().getSub())))
